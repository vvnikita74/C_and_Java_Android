...
char *personalization = "firstlab-sample-app";


#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "firstlab_ndk", __VA_ARGS__)
#define SLOG_INFO(...) android_logger->info( __VA_ARGS__ )
auto android_logger = spdlog::android_logger_mt("android", "firstlab_ndk");
